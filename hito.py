#creamos una clase para registrar los datos del usuario
...
class Producto:
    ...
    def mostrarDetalle(self):
        print(f'el producto {self.producto}, tiene un precio de {self.precios} y hay un total de {self.unidades} unidades')
